...
We can therefore present the general architecture for the transformer block:

```{mermaid}
graph LR
A(Input) -- embed --> B[[Embedding]]
C[[Embedding]] -- layer_norm --> D[MHSA]
D -- res_connect --> E[[Stage 1 Output]]
J[[Stage 1 Output]] -- layer_norm --> G[MLP]
G -- res_connect --> K(Final Output)

classDef blue fill:#0099ff,stroke:#0066cc,color:#ffffff;
class A,J,K,I blue;
classDef green fill:#00ff00,stroke:#006600,color:#ffffff;
class B,C,E,J green;
classDef orange fill:#ff9900,stroke:#cc6600,color:#ffffff;
class D,F,G,H orange;
```
