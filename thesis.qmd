...
![Sentence embeddings position per year](images/embeddings_year.png){fig-align="center"}
...
![Number of news per year](images/number_news_year.png){fig-align="center"}
...
![Embeddings with labels](images/embeddings_label.png){fig-align="center"}
...
In order to get a thorough and precise analysis of the way that sentence might or might not be relevant to analyze market moves, we will conduct a number of different linear regressions. The first one will be a very naïve regression with very minimal dimension reduction on embeddings. Since the original dimension for our embeddings is 1064, we will reduce the dimension to 500, a little less than half of the
